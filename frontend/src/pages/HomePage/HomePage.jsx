        ...
        <div>
          ...
          <table style={{ marginTop: "50px" }}>
            ...
            {user&&(loading==true&&<tr style={{paddingTop:"50px"}}>
                ...
                {user.id===1&&<td class="td-content"><button onClick={addQueue}>complete</button></td>}
            </tr>)}
            {user&&<tr>
              <td class="td-content"><input type="text" placeholder="Name" onChange={(e)=>setName(e.target.value)} value={name} name="queue_name"/></td>
